import { startOfWeek, startOfMonth, endOfWeek, endOfMonth, isBefore, addDays, isSameDay, isWithinRange, isSameMonth, addMonths, parse, isValid, min, max } from 'date-fns';
...
export const inDateRange = ({
  startDate,
  endDate
}, day) => startDate && endDate && (isWithinRange(day, startDate, endDate) || isSameDay(day, startDate) || isSameDay(day, endDate));
